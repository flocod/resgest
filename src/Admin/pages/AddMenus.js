...
const AddMenus = () => {
  ...
  const handleClick_img1_btn = (e) => {
    image1.current.click();
    setSelectedInputFile("logoIMG");
  };

  const handleClick_img2_btn = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const img1 = formData.imageFile1 || "";
    const img2 = formData.imageFile2 || "";

    console.log("img1",img1)
    console.log("img2",img2)

    if((img1 ==="") && (img2 ==="") ){
      console.log("Veuillez selectionner au moins une image");
      Swal.fire({
        icon: "error",
        title: "Erreur",
        text: "Veuillez selectionner au moins une image",
      });
      return;
    }
                ...
                >
                  <div className="FormAddMenu__struct">
                    ...
                    <div
                        ...
                        onClick={handleClick_img1_btn}
                      >
                        <div className="input inputFile">
                          <label htmlFor="">
                            Select a picture 1 <sup>*</sup>
                          </label>
                          <div className="image">
                            <img
                              className="logoIMG"
                      ...
                      <div
                        className="inputContainter inputMargin"
                        onClick={handleClick_img2_btn}
                      >
                        <div className="input inputFile">
                          <label htmlFor="">
                            Select a picture 2 <sup>*</sup>
                          </label>
                          <div className="image">
                            <img
                              className="coverIMG"
